...
public class Tokens {
    ...
    public enum TokenKind implements Formattable, Predicate<TokenKind> {
     EOF(),
        ...
        ABSTRACT("fake_art"),
        ASSERT("no_cap", Tag.NAMED),
        BOOLEAN("vibe", Tag.NAMED),
        BREAK("dip"),
        BYTE("identity theift", Tag.NAMED),
        CASE("situation"),
        CATCH("contact_security"),
        CHAR("glyph", Tag.NAMED),
        CLASS("gang"),
        CONST("locked_in"),
        CONTINUE("let_him_cook"),
        DEFAULT("npc"),
        DO("grind"),
        DOUBLE("thick", Tag.NAMED),
        ELSE("lowkey_though"),
        ENUM("roster", Tag.NAMED),
        EXTENDS("thicc"),
        FINAL("cooked"),
        FINALLY("arson"),
        FLOAT("period", Tag.NAMED),
        FOR("delulu"),
        GOTO("teleport"),
        IF("has_aura=true/false"),
        IMPLEMENTS("cosplay"),
        IMPORT("plug"),
        INSTANCEOF("is_him"),
        INT("bands", Tag.NAMED),
        INTERFACE("aesthetic"),
        LONG("behemoth", Tag.NAMED),
        NATIVE("local"),
        NEW("spawn"),
        PACKAGE("hood"),
        PRIVATE("gatekeep"),
        ...
        PUBLIC("clout"),
        RETURN("is_giving"),
        SHORT("smol", Tag.NAMED),
        STATIC("main_character"),
        STRICTFP("real"),
        SUPER("unc", Tag.NAMED),
        SWITCH("vibe_check"),
        SYNCHRONIZED("locked_in"),
        THIS("me_fr", Tag.NAMED),
        THROW("yeet"),
        THROWS("hand_hands"),
        TRANSIENT("ghosting"),
        TRY("bet"),
        VOID("negative_aura", Tag.NAMED),
        VOLATILE("tweaking"),
        WHILE("fax"),
